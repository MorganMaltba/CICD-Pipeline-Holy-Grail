...
function App() {
  ...
  return (
    <div className='grid'>
      <Header id='header' handle={handle} data={data} />
      <Left id='left' handle={handle} data={data} />
      <Article id='article' handle={handle} data={data} />
      <Right id='right' handle={handle} data={data} />
      <Footer id='footer' handle={handle} data={data} />
    </div>
  );
};
// ------------------------------------------------------------
